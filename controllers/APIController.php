...
class ApiController extends Controller
{
    ...
    public function actionList()
    {
        ...
        switch($_GET['model'])
        {
            case 'JournalImpactFactor': // {{{ 
                $models = JournalImpactFactor::model()->findAll();
                break; // }}}
			case 'JournalScimago': // {{{ 
                $models = JournalScimago::model()->findAll();
                break; // }}}  
            default: // {{{ 
    ...
    public function actionView()
	{
		...
		switch($_GET['model'])
		{
			...
			case 'JournalImpactFactor':
				$model = JournalImpactFactor::model()->findByPk($_GET['id']);
				break;
			case 'JournalScimago': // {{{ 
                $model = JournalScimago::model()->findByPk($_GET['id']);
                break; // }}}  
			default:
